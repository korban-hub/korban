                ...
                {projectMenuItems.map((item, index) => {
                  ...
                  return (
                    <button
                      key={item}
                      type="button"
                      onClick={() => handleProjectMenuAction(item)}
                      className={`block w-full px-4 py-2.5 text-left text-xs text-zinc-400 transition hover:bg-orange-500/10 hover:text-orange-300 ${
                        dividerBefore ? "border-t border-zinc-800" : ""
                      }`}
                    >
                      {item}
                    </button>
